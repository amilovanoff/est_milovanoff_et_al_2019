...
* Each function has attributes:
		...
		* exogenous attributes (i.e., attributes defined by the user for the simulation in architecture/attribute_value.csv) marker with the NA default value in the function; 
...
* To initiate the function, all the attributes need to be specified. 
		...
		* Then, the function attribute_f is simulated with the name of the model's function. This force the values of the exogenous attributes, which are not already specified, architecture/attribute_value.csv.